...
public class ArticleDao {
    ...
    public Article[] get_all(int page) {
        JdbcUtil jdbcUtil = JDBCConnection.JDBC;
        List<Object> paramList = new ArrayList<Object>();
        List<Map<String, Object>> result = null;
        Article art1 = new Article();
        ...
        try {
            result = jdbcUtil.findResult(
                    "SELECT * FROM `blog_article` LIMIT "+String.valueOf(page * 10-10)+" , "+result_num + ";", null);
            int i = 0;
            for (Map<String, Object> m : result) {
    ...
    public Article get_article(int which_article) {
        JdbcUtil jdbcUtil = JDBCConnection.JDBC;
        List<Object> paramList = new ArrayList<Object>();
        String art_id = String.valueOf(which_article);
