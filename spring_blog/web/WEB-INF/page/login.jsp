                                ...
                                <div class="Box-body px-5 pb-5">
                                    <article class="markdown-body entry-content container-lg">
                                        <div class="rounded-1 text-gray bg-gray-light py-4 px-4 px-md-3 px-lg-4">
                                            <form class="home-hero-signup text-gray-dark js-signup-form js-signup-form-submit" autocomplete="off" action="./do_login" accept-charset="UTF-8" method="post">
                                                ...
                                                <dl class="form-group mt-0">
                                                    ...
                                                    <dd>
                                                        <input type="text" name="username" class="form-control form-control-lg input-block" autocomplete="off" spellcheck="false">
                                                    </dd>
                                                </dl>
                                                ...
                                                <dl class="form-group">
                                                    ...
                                                    <dd>
                                                        <input type="text" id="email" name="email" class="form-control form-control-lg input-block js-email-notice-trigger" autocomplete="off" spellcheck="false">
                                                    </dd>
                                                </dl>
                                                ...
                                                <dl class="form-group">
                                                    ...
                                                    <dd>
                                                        <input type="password" name="password" class="form-control form-control-lg input-block js-email-notice-trigger" autocomplete="off" spellcheck="false">
                                                    </dd>
                                                </dl>

                                                <dl class="form-group">
                                                    <dt class="input-label">
                                                        <label class="form-label h5">Verification code</label> <a href="#" onclick=sendverifcode() >send code</a>
                                                    </dt>
                                                    <dd>
                                                        <input type="text" name="verficode_number" class="form-control form-control-lg input-block js-email-notice-trigger" autocomplete="off" spellcheck="false">
                                                    </dd>
                                                </dl>

                                                <p class="form-control-note text-gray-dark">I foget my password. <a href="/reset_password" class="tooltipped tooltipped-s" aria-label="Learn more about strong passwords">reset</a>.</p>


                                                <!--//登录按钮 我的注释-->
                                                <button type="submit" class="btn-mktg btn-primary-mktg btn-large-mktg f4 btn-block my-3" >Login Skay's Blog</button>
                                            </form>  </div>
                            ...
                            <div class="BorderGrid BorderGrid--spacious" data-pjax="">
                                <div class="BorderGrid-row hide-sm hide-md">
                                    <div class="BorderGrid-cell">
                                        ...
                                        <h2 class="mb-3 h4">First</h2>

                                        <p class="f4 mt-3">
                                            Welcome to My Channl.											</p>


                                        <!--                                        <div class="mt-3">-->
                                        <!--                                            <a class="muted-link" href="/index/view/269.html">-->
                                ...
                                <div class="BorderGrid-row">
                                    <div class="BorderGrid-cell">
                                        <h2 class="h4 mb-3">
                                            <a class="link-gray-dark no-underline ">
                                                Second
                                            </a></h2>

                                        <div class="text-small">欢迎留下你的联系方式，欢迎交换友链</div>
