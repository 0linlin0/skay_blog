...
public class AESUtils {
     ...
     * @author:[全冉]
     */
    public static String encodes(String content, String key) {
     ...
     * @author:[全冉]
     */
    public static String decodes(String content, String key) {
        if (content == null || content.length() < 1) {
            return null;
        }
